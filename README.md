...
2. Gắn dây nạp cho STM32.
3. Mở file project trên STM32CubeIDE để compile và chạy chương trình.
4. Gắn module CP2102 vào cổng USB của máy tính, mở Device Manager kiểm tra trạng thái kết nối.
5. Mở Hercules, chọn Serial, chọn cổng COM đúng và bấm Open để thấy kết quả số random hiện trên màn hình.
